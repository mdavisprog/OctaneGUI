...
SET CMAKE_OPTIONS=%CMAKE_OPTIONS% -DTOOLS=%BUILD_TOOLS% -DWINDOWING=%WINDOWING% -DRENDERING=%RENDERING% -DNO_APPS=%NO_APPS%
SET CMAKE_OPTIONS=%CMAKE_OPTIONS% -DWITH_LSTALK=%WITH_LSTALK%
